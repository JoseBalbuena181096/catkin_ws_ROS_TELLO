...
set(MSG_I_FLAGS "-Iflock_msgs:/home/jose/catkin_ws/src/flock/flock_msgs/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/jose/catkin_ws/src/flock/flock_msgs/msg/FlightData.msg" NAME_WE)
add_custom_target(_flock_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "flock_msgs" "/home/jose/catkin_ws/src/flock/flock_msgs/msg/FlightData.msg" ""
)

get_filename_component(_filename "/home/jose/catkin_ws/src/flock/flock_msgs/msg/Flip.msg" NAME_WE)
add_custom_target(_flock_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "flock_msgs" "/home/jose/catkin_ws/src/flock/flock_msgs/msg/Flip.msg" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/flock_msgs)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/flock_msgs\")")
  # install generated code
  install(
