...
int main(int argc, char** argv) {
  ...
  takeoff_sub = nh.subscribe("/bebop2/takeoff", 10, &TakeoffCallback);
  land_sub = nh.subscribe("/bebop2/land", 10, &LandCallback);
  stop_sub = nh.subscribe("/bebop2/reset", 10, &StopCallback);
  move_sub = nh.subscribe("/bebop2/cmd_vel", 10, &MoveCallback);
